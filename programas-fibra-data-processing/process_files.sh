...
tippecanoe -z18 --projection=EPSG:4326 -o unico2024.pmtiles -l output -no-feature-limit --no-tile-size-limit --detect-shared-borders unico2024.geojson --force
...
tippecanoe -z18 --projection=EPSG:4326 -o unico2023.pmtiles -l output -no-feature-limit --no-tile-size-limit --detect-shared-borders unico2023.geojson --force
...
tippecanoe -z18 --projection=EPSG:4326 -o unico2022.pmtiles -l -no-feature-limit --no-tile-size-limit --detect-shared-borders output unico2022.geojson --force
...
tippecanoe -z18 --projection=EPSG:4326 -o unico2021.pmtiles -l -no-feature-limit --no-tile-size-limit --detect-shared-borders output unico2021.geojson --force
...
tippecanoe -z18 --projection=EPSG:4326 -o peba2019.pmtiles -l output --no-clipping --drop-rate=0 --no-feature-limit --no-tile-size-limit -r1 peba2019.geojson --force
...
tippecanoe -z18 --projection=EPSG:4326 -o peba2018.pmtiles -l output --no-clipping --drop-rate=0 --no-feature-limit --no-tile-size-limit -r1 peba2018.geojson --force
...
tippecanoe -z18 --projection=EPSG:4326 -o peba2017.pmtiles -l output --no-clipping --drop-rate=0 --no-feature-limit --no-tile-size-limit -r1 peba2017.geojson --force
...
tippecanoe -z18 --projection=EPSG:4326 -o peba2016.pmtiles -l output --no-clipping --drop-rate=0 --no-feature-limit --no-tile-size-limit -r1 peba2016.geojson --force
...
tippecanoe -z18 --projection=EPSG:4326 -o peba2015.pmtiles -l output --no-clipping --drop-rate=0 --no-feature-limit --no-tile-size-limit -r1 peba2015.geojson --force
...
tippecanoe -z18 --projection=EPSG:4326 -o peba2014.pmtiles -l output --no-clipping --drop-rate=0 --no-feature-limit --no-tile-size-limit -r1 peba2014.geojson --force
...
tippecanoe -z18 --projection=EPSG:4326 -o peba2013.pmtiles -l output --no-clipping --drop-rate=0 --no-feature-limit --no-tile-size-limit -r1 peba2013.geojson --force
tile-join -o merged.pmtiles --no-tile-size-limit unico2024.pmtiles unico2023.pmtiles unico2022.pmtiles unico2021.pmtiles peba2021.pmtiles peba2020.pmtiles peba2019.pmtiles peba2018.pmtiles peba2017.pmtiles peba2016.pmtiles peba2015.pmtiles peba2014.pmtiles peba2013.pmtiles --force
