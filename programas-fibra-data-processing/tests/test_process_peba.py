...
import numpy as np
from test_data_peba import (
    AREAS_DF,
    AREAS_DF_WITHOUT_EXCEPTION_ZONE,
    AREAS_FFILL_DF,
    AREAS_FFILLED_DF,
    AREAS_OLD_PEBA_DF,
    ENTITIES_DF,
...
def test_create_properties_with_no_exception_zone():
    project_to_grantee = {"TSI-061000-2018-0001": "INFORMATICA FUENTEALBILLA S.L."}
    row = (
        1,
        math.nan,
    ...
    expected_area_properties = AreaPropertiesTown(
        "PEBA-NGA 2018-2020",
        "CASTILLA LA MANCHA",
        "ALBACETE",
        "Casas de Juan Núñez",
...
def test_create_properties_with_exception_zone():
    project_to_grantee = {"TSI-061000-2018-0004": "REDES ÓPTICAS SALMANTINAS S.L."}
    row = (
        5,
        math.nan,
        "TSI-061000-2018-0004",
        "CASTILLA LEON",
        "SALAMANCA",
        "Castellanos de Moriscos",
        "POLÍGONO INDUSTRIAL",
        "37092000400",
        "37092000400-2018-zona01",
        "POLÍGONO INDUSTRIAL CASTELLANOS DE MORISCOS",
    )
    properties = create_properties(row, project_to_grantee, "PEBA-NGA 2018-2020", False)
    expected_area_properties = AreaPropertiesTown(
        "PEBA-NGA 2018-2020",
...
def test_create_properties_with_leading_zero_in_projects_sheet():
    project_to_grantee = {"TSI-061000-2015-0102": "VODAFONE ESPAÑA S.A."}
    row = (
        5,
        math.nan,
        "TSI-061000-2015-102",
...
def test_create_properties_with_leading_zero_in_areas_sheet():
    project_to_grantee = {"TSI-061000-2015-102": "VODAFONE ESPAÑA S.A."}
    row = (
        5,
        math.nan,
        "TSI-061000-2015-0102",
        "Cataluña",
        "GIRONA",
        "BLANES",
        "BLANES",
...
def _create_point(
    coordinates: tuple[float, float], properties: AreaProperties
) -> Feature:
    return Feature(
        geometry=Point(coordinates), properties={**properties.__dict__, "type": "town"}
    )
...
def test_map_awarded_areas(mock_to_geojson, mock_create_properties, df):
    ...
    collection = map_awarded_areas(
        df, project_to_grantee, code_to_coordinates, "PEBA-NGA 2018-2020", False
    )
    ...
    mock_create_properties.assert_any_call(
        expected_rows[0], project_to_grantee, "PEBA-NGA 2018-2020", False
    )
    mock_create_properties.assert_any_call(
        expected_rows[1], project_to_grantee, "PEBA-NGA 2018-2020", False
    )
    mock_create_properties.assert_any_call(
        expected_rows[2], project_to_grantee, "PEBA-NGA 2018-2020", False
    )

    assert mock_to_geojson.call_count == 3

    mock_to_geojson.assert_any_call(
        AreaPropertiesTown(
            program_name="PEBA-NGA 2018-2020",
            autonomous_community="CASTILLA LA MANCHA",
            province="ALBACETE",
            municipality="Casas de Juan Núñez",
            project="TSI-061000-2018-0001",
            grantee="INFORMÁTICA FUENTEALBILLA S.L.",
            town="CASAS DE JUAN NÚÑEZ",
            exception_zone_code=None,
            exception_zone_name=None,
        ),
        (39.10267748, -1.55853519),
    )
    mock_to_geojson.assert_any_call(
        AreaPropertiesTown(
            program_name="PEBA-NGA 2018-2020",
            ...
            project="TSI-061000-2018-0002",
            grantee="INFORMÁTICA FUENTEALBILLA S.L.",
            town="AGUAS NUEVAS",
            exception_zone_code=None,
            exception_zone_name=None,
        ),
        (38.91810162, -1.92043947),
    )
    mock_to_geojson.assert_any_call(
        AreaPropertiesTown(
            program_name="PEBA-NGA 2018-2020",
            autonomous_community="C.VALENCIANA",
            province="VALENCIA / VALÈNCIA",
            municipality="Real",
            project="TSI-061000-2018-0003",
            grantee="INFORMÁTICA FUENTEALBILLA S.L.",
            town="REAL",
            exception_zone_code=None,
            exception_zone_name=None,
        ),
        (39.33552389, -0.60948808),
    )
...
def test_awarded_areas(
    mock_excel_file, mock_ine_code_to_coordinates, mock_map_awarded_areas
):
    ine_code_to_coordinates = {
        2021000100: (39.10267748, -1.55853519),
        2003000100: (38.91810162, -1.92043947),
    ...
    mock_excel_instance.sheet_names = [
        "Beneficiarios Conv 2018",
        "Ámbito geográfico actuación",
    ]
    ...
    properties = awarded_areas(
        "test_file.xlsx", "test_entities.csv", "PEBA-NGA 2018-2020"
    )
...
@patch("lib.process_peba.ine_code_to_coordinates")
@patch("pandas.ExcelFile")
def test_awarded_areas_old_peba(
    mock_excel_file, mock_ine_code_to_coordinates, mock_map_awarded_areas
):
    ine_code_to_coordinates = {
        2021000100: (39.10267748, -1.55853519),
    ...
    properties = awarded_areas(
        "test_file.xlsx", "test_entities.csv", "PEBA-NGA 2013-2015"
    )
...
def test_awarded_areas_ffill(
    ...
    properties = awarded_areas(
        "test_file.xlsx", "test_entities.csv", "PEBA-NGA 2016-2018"
    )
