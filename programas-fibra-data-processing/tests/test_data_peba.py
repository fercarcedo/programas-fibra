...
PROJECTS_OLD_PEBA_DF = pd.DataFrame(
    {
        ...
        2: [
            ...
            "MAGTEL COMUNICACIONES AVANZADAS S.L.",
            np.nan,
            np.nan,
            np.nan,
        ],
...
PROJECTS_FFILL_DF = pd.DataFrame(
    {
        ...
        12: [
            np.nan,
            np.nan,
            "Enlace a oferta mayorista",
            "https://www.euskaltel.com/empresas/soy-cliente/tengo-dudas-sobre/descargas/tarifas/condiciones-generales-de-contratacion",
        ],
    }
)
